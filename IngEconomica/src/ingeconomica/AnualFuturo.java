 ...
 * @author CR-26
 */
public class AnualFuturo extends javax.swing.JFrame {

    /**
     * Creates new form AnualFuturo
     */
    public AnualFuturo() {
        initComponents();
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calcular Anual / Futuro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnualFuturo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnualFuturo().setVisible(true);
            }
        });
    }
